...
# Parsing + Configuration Script – WM0239 - Rev. A

This **Parsing + Configuration** script is designed for the **WM0239** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – WM0239 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **WM0239** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
